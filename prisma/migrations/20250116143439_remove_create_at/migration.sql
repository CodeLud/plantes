/*
  ...
  - You are about to drop the column `createdAt` on the `Plante` table. All the data in the column will be lost.
  - You are about to drop the column `updatedAt` on the `Plante` table. All the data in the column will be lost.
